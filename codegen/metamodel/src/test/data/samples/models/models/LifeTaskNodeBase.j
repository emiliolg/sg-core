...
/** 
 * Generated base class for task: LifeTaskNode.
 * Don't modify this as this is an auto generated class that's gets generated
 * every time the meta model file is modified. Use subclass instead.
 */
@SuppressWarnings("WeakerAccess")
public abstract class LifeTaskNodeBase
    ...
    implements LoggableInstance
{
    ...
    protected LifeTaskNodeBase(@NotNull LifecycleTask task) { super(task); }
    ...
    @NotNull private static final Logger logger = Logger.getLogger(LifeTaskNode.class);
