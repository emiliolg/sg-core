...
/** 
 * Generated base class for task: RunnableTask.
 * Don't modify this as this is an auto generated class that's gets generated
 * every time the meta model file is modified. Use subclass instead.
 */
@SuppressWarnings("WeakerAccess")
public abstract class RunnableTaskBase
    ...
    implements LoggableInstance
{
    ...
    protected RunnableTaskBase(@NotNull ScheduledTask task) { super(task); }
    ...
    @Override @NotNull public String getExclusionGroup() { return "A"; }
    ...
    @NotNull private static final Logger logger = Logger.getLogger(RunnableTask.class);
