    ...
    implements LoggableInstance
{
    ...
    @NotNull public ChildWidget setId(@NotNull String id) {
        f.set(Field.ID, id);
        return (ChildWidget) this;
    }
    ...
    @NotNull private static final Logger logger = Logger.getLogger(ChildWidget.class);
