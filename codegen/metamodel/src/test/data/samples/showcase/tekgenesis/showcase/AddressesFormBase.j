...
import tekgenesis.showcase.AddressesForm.ClientAddressesRow;
    ...
    implements LoggableInstance
{
    ...
    @NotNull public AddressesForm setId(@Nullable Integer id) {
        f.set(Field.ID, id);
        return (AddressesForm) this;
    }
    ...
    public static void addListener(@NotNull FormListenerType listenerType, @NotNull FormListener<AddressesForm> listener) { listeners.addListener(listenerType, listener); }

    /** Remove a form Listener */
    public static void removeListener(@NotNull FormListenerType listenerType, @NotNull FormListener<AddressesForm> listener) { listeners.removeListener(listenerType, listener); }
    ...
    @NotNull private static FormListenerMap<AddressesForm> listeners = new FormListenerMap<>();
    @NotNull private static final Logger logger = Logger.getLogger(AddressesForm.class);
        ...
        implements FormRowInstance<ClientAddressesRow>
    {
        ...
        @NotNull public abstract Action resetState();
