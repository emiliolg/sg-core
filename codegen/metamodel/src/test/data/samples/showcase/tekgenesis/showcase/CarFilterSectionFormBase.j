...
import tekgenesis.showcase.CarFilterSectionForm.CarsRow;
...
import tekgenesis.showcase.CarFilterSectionForm.FiltersRow;
    ...
    implements LoggableInstance
{
    ...
    @NotNull public final Void populate() {
        throw new FormCannotBePopulatedException("tekgenesis.showcase.CarFilterSectionForm");
    }
    ...
    public static void addListener(@NotNull FormListenerType listenerType, @NotNull FormListener<CarFilterSectionForm> listener) { listeners.addListener(listenerType, listener); }

    /** Remove a form Listener */
    public static void removeListener(@NotNull FormListenerType listenerType, @NotNull FormListener<CarFilterSectionForm> listener) { listeners.removeListener(listenerType, listener); }
    ...
    @NotNull private static FormListenerMap<CarFilterSectionForm> listeners = new FormListenerMap<>();
    @NotNull private static final Logger logger = Logger.getLogger(CarFilterSectionForm.class);
