    ...
    implements LoggableInstance
{
    ...
    @NotNull public ReverseAddressForm setId(@Nullable Integer id) {
        f.set(Field.ID, id);
        return (ReverseAddressForm) this;
    }

    /** Invoked when text_field(country) value changes */
    @NotNull public abstract Action resetAboveFields();
    ...
    @NotNull public ReverseAddressForm setCountry(@NotNull String country) {
    ...
    @NotNull public ReverseAddressForm setState(@Nullable String state) {
    ...
    @NotNull public ReverseAddressForm setCity(@NotNull String city) {
    ...
    @NotNull public ReverseAddressForm setStreet(@NotNull String street) {
    ...
    @NotNull public ReverseAddressForm setZip(@Nullable String zip) {
        f.set(Field.ZIP, zip);
        return (ReverseAddressForm) this;
    }

    /** Register a form Listener */
    public static void addListener(@NotNull FormListenerType listenerType, @NotNull FormListener<ReverseAddressForm> listener) { listeners.addListener(listenerType, listener); }

    /** Remove a form Listener */
    public static void removeListener(@NotNull FormListenerType listenerType, @NotNull FormListener<ReverseAddressForm> listener) { listeners.removeListener(listenerType, listener); }
    ...
    @NotNull private static FormListenerMap<ReverseAddressForm> listeners = new FormListenerMap<>();
    @NotNull private static final Logger logger = Logger.getLogger(ReverseAddressForm.class);
