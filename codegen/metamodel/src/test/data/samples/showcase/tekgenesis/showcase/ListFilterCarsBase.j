...
import tekgenesis.showcase.ListFilterCars.CarsRow;
...
import tekgenesis.showcase.ListFilterCars.FiltersRow;
    ...
    implements LoggableInstance
{
    ...
    @NotNull public final Void populate() {
        throw new FormCannotBePopulatedException("tekgenesis.showcase.ListFilterCars");
    }
    ...
    /** Invoked when cars lazy requests items. */
    @Nullable public Action lazyLoadCars(int offset, int limit) {
        Car.list().offset(offset).limit(limit).list().forEach(c -> getCars().add().populate(c));
        return actions().getDefault();
    }

    /** Register a form Listener */
    public static void addListener(@NotNull FormListenerType listenerType, @NotNull FormListener<ListFilterCars> listener) { listeners.addListener(listenerType, listener); }

    /** Remove a form Listener */
    public static void removeListener(@NotNull FormListenerType listenerType, @NotNull FormListener<ListFilterCars> listener) { listeners.removeListener(listenerType, listener); }
    ...
    @NotNull private static FormListenerMap<ListFilterCars> listeners = new FormListenerMap<>();
    @NotNull private static final Logger logger = Logger.getLogger(ListFilterCars.class);
