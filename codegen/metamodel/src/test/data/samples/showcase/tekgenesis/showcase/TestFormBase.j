    ...
    implements LoggableInstance
{
    ...
    @NotNull public TestForm setName(@NotNull String name) {
    ...
    @NotNull public TestForm setDescription(@NotNull String description) {
        f.set(Field.DESCRIPTION, description);
        return (TestForm) this;
    }

    /** Register a form Listener */
    public static void addListener(@NotNull FormListenerType listenerType, @NotNull FormListener<TestForm> listener) { listeners.addListener(listenerType, listener); }

    /** Remove a form Listener */
    public static void removeListener(@NotNull FormListenerType listenerType, @NotNull FormListener<TestForm> listener) { listeners.removeListener(listenerType, listener); }
    ...
    @NotNull private static FormListenerMap<TestForm> listeners = new FormListenerMap<>();
    @NotNull private static final Logger logger = Logger.getLogger(TestForm.class);
