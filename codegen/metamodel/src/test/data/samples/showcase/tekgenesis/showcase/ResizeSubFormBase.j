    ...
    implements LoggableInstance
{
    ...
    @NotNull public ResizeSubForm setId(@Nullable Integer id) {
        f.set(Field.ID, id);
        return (ResizeSubForm) this;
    }
    ...
    @NotNull public ResizeSubForm setStreet(@NotNull String street) {
    ...
    @NotNull public ResizeSubForm setCity(@NotNull String city) {
    ...
    @NotNull public ResizeSubForm setState(@Nullable String state) {
    ...
    @NotNull public ResizeSubForm setZip(@Nullable String zip) {
        f.set(Field.ZIP, zip);
        return (ResizeSubForm) this;
    }
    ...
    @NotNull public ResizeSubForm setCountry(@NotNull String country) {
        f.set(Field.COUNTRY, country);
        return (ResizeSubForm) this;
    }

    /** Returns the value of the toggle_button(enlarge). */
    public boolean isEnlarge() { return f.get(Field.ENLARGE, Boolean.class); }

    /** Sets the value of the toggle_button(enlarge). */
    @NotNull public ResizeSubForm setEnlarge(boolean enlarge) {
        f.set(Field.ENLARGE, enlarge);
        return (ResizeSubForm) this;
    }

    /** Register a form Listener */
    public static void addListener(@NotNull FormListenerType listenerType, @NotNull FormListener<ResizeSubForm> listener) { listeners.addListener(listenerType, listener); }

    /** Remove a form Listener */
    public static void removeListener(@NotNull FormListenerType listenerType, @NotNull FormListener<ResizeSubForm> listener) { listeners.removeListener(listenerType, listener); }
    ...
    @NotNull private static FormListenerMap<ResizeSubForm> listeners = new FormListenerMap<>();
    @NotNull private static final Logger logger = Logger.getLogger(ResizeSubForm.class);
