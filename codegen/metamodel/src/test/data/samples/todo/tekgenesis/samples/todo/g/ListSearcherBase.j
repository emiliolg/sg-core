...
/** Base class for index and searching tekgenesis.samples.todo.List */
public class ListSearcherBase
    extends InstanceSearcher
{
    ...
    protected ListSearcherBase() { super(field("name", STRING).build()); }
    ...
    @Nullable private static final String ENTITY_FQN = "tekgenesis.samples.todo.List";
