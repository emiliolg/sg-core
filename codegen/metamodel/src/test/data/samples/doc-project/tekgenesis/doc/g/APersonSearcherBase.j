...
/** Base class for index and searching tekgenesis.doc.APerson */
public class APersonSearcherBase
    extends InstanceSearcher
{
    ...
    @Nullable private static final String ENTITY_FQN = "tekgenesis.doc.APerson";
