    ...
    implements LoggableInstance
{
    ...
    @NotNull public BindingAddressWidget setStreet(@NotNull String street) {
        f.set(Field.STREET, street);
        return (BindingAddressWidget) this;
    }
    ...
    @NotNull public BindingAddressWidget setNumber(int number) {
    ...
    @NotNull public BindingAddressWidget setPostal(int postal) {
    ...
    @NotNull public BindingAddressWidget setPrimary(boolean primary) {
    ...
    @NotNull private static final Logger logger = Logger.getLogger(BindingAddressWidget.class);
