...
/** 
 * Generated remote service class for handler: VoidHandler.
...
public class VoidHandlerRemote
{
    ...
    public VoidHandlerRemote(@NotNull HttpInvoker invoker) {
    ...
    @NotNull public InvokerCommand<?> str(@NotNull String id) {
