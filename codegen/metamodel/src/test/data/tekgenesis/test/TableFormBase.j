...
import tekgenesis.test.TableForm.MyItemRow;
    ...
    implements LoggableInstance
{
    ...
    @NotNull public final Void populate() {
        throw new FormCannotBePopulatedException("tekgenesis.test.TableForm");
    }
    ...
    public static void addListener(@NotNull FormListenerType listenerType, @NotNull FormListener<TableForm> listener) { listeners.addListener(listenerType, listener); }

    /** Remove a form Listener */
    public static void removeListener(@NotNull FormListenerType listenerType, @NotNull FormListener<TableForm> listener) { listeners.removeListener(listenerType, listener); }
    ...
    @NotNull private static FormListenerMap<TableForm> listeners = new FormListenerMap<>();
    @NotNull private static final Logger logger = Logger.getLogger(TableForm.class);
