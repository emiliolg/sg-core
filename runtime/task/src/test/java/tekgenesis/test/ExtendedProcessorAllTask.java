...
/**
 * User class for Task: ExtendedProcessorAllTask
 */
public class ExtendedProcessorAllTask extends ExtendedProcessorAllTaskBase<Object> implements ExtendedProcessorBaseTask.ExtendedProcesorTask {
    ...
    private ExtendedProcessorAllTask(@NotNull ScheduledTask task) {
        super(task);
...
}  // end class ExtendedProcessorAllTask
