...
create table QName(SG, TASK_EXECUTION_LOG) (
	...
	SUCCESS_ITEMS_COUNT               int              default 0                not null,
	ERROR_ITEMS_COUNT                 int              default 0                not null,
	IGNORE_ITEMS_COUNT                int              default 0                not null,
	TASK_UPDATE_TIME                  datetime(3)      default CurrentTime      not null,
	UPDATE_TIME                       datetime(3)      default CurrentTime      not null,
...
create index IndexName(SG, TASK_EXECUTION_LOG_645606_IDXT)
	on QName(SG, TASK_EXECUTION_LOG) (UPDATE_TIME) IndexTableSpace;;
