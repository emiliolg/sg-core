...
create table QName(AUTHORIZATION, ORG_UNIT_PROPERTIES) (
	ORG_UNIT_NAME                     nvarchar(10)     default EmptyString      not null,
	SEQ_ID                            int              default 0                not null,
	PROPERTY_ID                       nvarchar(10)     default EmptyString      not null,
	PROPERTY_NAME                     nvarchar(20)     default EmptyString      not null,
	PROPERTY_TYPE                     nvarchar(50)     default 'STRING'         not null,
...
create table QName(AUTHORIZATION, PERMISSIONS) (
	ROLE_PERMISSION_ID                int              default 0                not null,
	SEQ_ID                            int              default 0                not null,
...
create table QName(AUTHORIZATION, ROLE_ASSIGNMENT) (
	USER_ID                           nvarchar(256)    default EmptyString      not null,
	ROLE_ID                           nvarchar(20)     default EmptyString      not null,
	OU_NAME                           nvarchar(10)     default EmptyString      not null,
	UPDATE_TIME                       datetime(3)      default CurrentTime      not null,
