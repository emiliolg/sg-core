...
/**
 * A {@link Change} that indicates an {@link Attribute} option has been added.
 */
public class AttributeOptionAdded implements Change {
    ...
    public AttributeOptionAdded(Attribute attribute, FieldOption option) {
    ...
    @Override public String getMessage() {
        return OPTION_SPC + quoted(option.getId()) + HAS_BEEN_ADDED + IN_ATTRIBUTE + attribute.getFullName();
    }
}
